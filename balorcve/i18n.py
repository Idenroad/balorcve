...
translations = {
    "fr": {
        ...
        "download_default_year": "Voulez-vous télécharger le fichier {year} par défaut ? (y/n)",
    ...
    "en": {
        ...
        "download_default_year": "Do you want to download the default {year} file? (y/n)",
